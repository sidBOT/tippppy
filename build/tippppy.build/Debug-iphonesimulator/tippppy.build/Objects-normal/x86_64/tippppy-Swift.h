...
SWIFT_CLASS("_TtC7tippppy11AppDelegate")
...
SWIFT_CLASS("_TtC7tippppy20SecondViewController")
@interface SecondViewController : UIViewController
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified percentageSegment;
@property (nonatomic, readonly, strong) ViewController * _Nonnull vc;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7tippppy14ViewController")
...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified tipController;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)onTap:(id _Nonnull)sender;
- (IBAction)valueChanged:(id _Nonnull)sender;
- (IBAction)calculateTip:(id _Nonnull)sender;
- (IBAction)changed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
